...
import cer0 from "./assets/cs50x-certificate.png";
...
"
              ...
              <div className="w-full flex items-center justify-center mt-18 text-3xl gap-4">
                ...
                <a
                  href="https://instagram.com/parsahsnys"
                  className="p-2 bg-zinc-900 rounded-xl border-1 border-white/20 md:hover:bg-zinc-800"
                >
                  <FaInstagram />
                </a>
                <a
                  href="https://t.me/lilparsax"
                  className="p-2 bg-zinc-900 rounded-xl border-1 border-white/20 md:hover:bg-zinc-800"
                >
                  <FaTelegramPlane />
                </a>
                      ...
                      <div className="absolute flex items-center inset-0 bg-gradient-to-r from-zinc-900/50 md:from-zinc-900/5 to-zinc-900 z-10">
                        <div className="w-full md:w-[50%] text-4xl font-bold text-center">
                          ...
                          <p className="text-sm pt-2 font-light text-white/90">
                            فیلمبردای، عکسبرداری و مدیریت سوشیال مدیا
                          </p>
                        </div>
                      </div>
                    </div>
              ...
              <div className="mt-18 mb-18" id="contact_section">
                ...
                <form
                  ...
                  method="POST"
                  className="w-full p-8 rounded-2xl col-span-2 bg-white/1.5 shadow-xl"
                >
                  <div className="bg-blue-500/50 border-1 border-blue-500 text-center rounded-xl p-2 mb-4">
                    <p>
                      لطفا در صورت مشاهده باگ در وبسایت از طریق فرم زیر به ما
                      اعلام کنید !!!
                    </p>
                  </div>
